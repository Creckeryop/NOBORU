        ...
        local f_save = function()
            ...
            elseif Task.Type == 'Image' then
                if System.doesFileExist(Task.Path) then
                    ...
                    if
                        GetTextureMemoryUsed() + bit32.band(bit32.bor(Width, 7), bit32.bnot(7)) * Height * 4 >
                        96 * 1024 * 1024
                    then
            ...
            elseif Task.Type == 'ImageLoadTable' then
                ...
                if Task.Image.i < Task.Image.Parts then
                    Console.write(
                        'Getting ' ..
                        (Task.Table[Task.Index].part_h * Task.Image.i) ..
                        ' ' .. (Task.Image.Width) .. ' ' .. Height .. ' Image'
                    )
                    Graphics.loadPartImageAsync(
                        Task.Path,
                        0,
                        Task.Table[Task.Index].part_h * Task.Image.i,
                        Task.Image.Width,
