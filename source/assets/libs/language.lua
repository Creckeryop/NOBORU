...
Language = {
	...
	Turkish = {
		...
		MESSAGE = {
			...
			NO_LIBRARY_MANGA = "Hiç Çizgi Roman veya Manga Yok\nManga veya Çizgi Roman Eklemek İçin, \"KATALOGLAR\" Menüsünü Açıp \"Kütüphaneye Ekle\" Seçeneğini Seçin.", 
	...
	French = {
		...
		MESSAGE = {
			...
			NO_LIBRARY_MANGA = "Pas de manga/comics.\nPour ajouter des mangas/comics, vous pouvez aller dans le menu\"CATALOGUE\" et appuyer \"Ajouter à la librairie\".",
	...
	Polish = {
		...
		MESSAGE = {
			...
			NO_CATALOGS = "Brak katalogów.\nNaciśnij Trójkąt i poczekaj aż zostaną załadowane.",
		...
		SETTINGS = {
			...
			DoubleTapReader = "Włącz podwójne tapnięcie aby przybliżyć",
			...
			HideInOffline = "W trybie offline pokazuj tylko pobrane rozdziały",
			...
			SkipCacheChapterChecking = "Pomiń sprawdzanie pamięci podręcznej i zapisanych rozdziałów w trakcie ładowania",
