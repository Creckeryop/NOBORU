...
Language = {
	...
	Ryukyuan = {
		APP = {
			...
			CATALOGS = "カタログ",
			SETTINGS = "設定",
			DOWNLOAD = "ダウンロード中ぬすむち",
			IMPORT = "インポート",
			HISTORY = "履歴",
			SEARCH = "検索"
		},
		MESSAGE = {
			LOST_CONNECTION = "「接続ぬ失らりやびたん\n\n接続待機そーいびーん... \n \n（アプリケーション最小化しー、Wi-Fi設定んかい移動し[接続]うさびーん）\n\nXうちまじりぬダウンロードキャンセルしー、くーやびーん。",
			PRESS_TO_UPDATE = "Xうち更新さびーん\nOうちキャンセルさびーん。",
			NO_LIBRARY_MANGA = "漫画/コミッコーあいびらん。\n漫画/コミックいりしーんがー、\n[カタログ]メニューっし漫画てぃがろーコミック見ーちきてぃ、\n[ライブラリんかい追加]うさびーん。",
			NO_HISTORY_MANGA = "漫画/コミッコーあいびらん。\nいちかくまんかい表示さりやびーん",
			NO_CATALOG_MANGA = "マンガ/コミッコーあいびらん。\nサーバー、接続、あらんでぃパーサーぬエラー",
			NO_DOWNLOADING_MANGA = "マンガ/コミックぬダウンロードーあいびらん。",
			NO_CATALOGS = "カタログぬあいびらん。\n三角形うち、まじりぬカタログぬ読み込まりーんまでぃ待ちゃびーん",
			THANK_YOU = "プロジェクトサポートしいただちにふぇーでーびる！",
		},
			SETTINGS = {
			Language = "言語",
			AdvancedChaptersDeletion = "高度な章ぬ削除",
			DonatorsList = "寄付者リスト",
			ClearChapters = "たぶたるチャプターまじり削除すん",
			ShowNSFW = "NSFWカタログ表示すん",
			ClearLibrary = "ライブラリー削除",
			ClearCache = "フォローさりてぃうぅらんマンガぬキャッシュ削除すん",
			ClearAllCache = "まじりぬキャッシュ削除すん",
			ReaderOrientation = "デフォルトぬリーダーぬんけー",
			DoubleTapReader = "ダブルタップっしズーム有効なすん",
			ZoomReader = "リーダーぬスケーリング",
			SwapXO = "XボタンとぅOボタン入りけーいん",
			ShowAuthor = "開発者",
			ShowVersion = "現在ぬバージョン",
			CheckUpdate = "最新ぬ更新チェックすん",
			SkipFontLoading = "フォントぬロード無視すん",
			LatestVersion = "最新ぬ更新 : ",
			PleaseWait = "いちゅた待っちくぃみそーれー。",
			FailedToUpdate = "アプリぬ更新んかいしーやんじゃびたん。なーいちどぅしーけーちくぃみそーれー。",
			NoConnection = "接続ぬあいびらん。",
			HideInOffline = "ダウンロードさるチャプターぬみオフラインモードっし表示すん",
			UnzipingVPK = "インストールするvpk抽出",
			CurrentVersionIs = "現在ぬバージョノー次ぬとおりやいびーん",
			Space = "使用さるメモリ",
			ReaderDirection = "漫画ぬ読み方",
			VersionIsUpToDate = "うちけーぬバージョノー最新やいびーん。",
			EU = "ヨーロッパ",
			JP = "やまとぅ",
			PressAgainToAccept = "なーいちどぅうすんでぃ受き入りやびーん",
			PressAgainToUpdate = "なーいちどぅうしねー更新さりやびーん",
			Reader = "リーダー",
			Controls = "コントロールぬセットアップ",
			Data = "データぬ設定",
			About = "プログラムにちいてぃ",
			Catalogs = "カタログ",
			Library = "ライブラリー",
			ChangeUI = "テーマ",
			PreferredCatalogLanguage = "優先する言語",
			LibrarySorting = "ライブラリぬ並べい替い",
			ChapterSorting = "チャプターぬ並べい替い",
			RefreshLibAtStart = "起動時にライブラリ更新",
			Translators = "NOBORU翻訳しくぃたる方んかい感謝さびーん。",
			ChangingPageButtons = "ページ変更ぬボタン変更",
			LeftStickDeadZone = "ふぃじゃいスティックぬデッドゾーン変更",
			LeftStickSensitivity = "ふぃじゃいスティックぬ感度",
			RightStickDeadZone = "にじりスティックぬデッドゾーン変更",
			RightStickSensitivity = "にじりスティックぬ感度",
			ResetAllSettings = "まじりぬ設定リセット",
			Other = "すぬ他",
			SilentDownloads = "ダウンロード通知表示さん",
			Network = "ネットワーク",
			UseProxy = "プロキシ使用",
			ProxyIP = "IPアドレス",
			ProxyPort = "ポート",
			UseProxyAuth = "プロキシ認証使用",
			ProxyAuth = "ログインパスワード",
			SkipCacheChapterChecking = "ロード中んかいキャッシュとぅたぶらったるチャプターぬチェックスキップ",
			ConnectionTime = "サーバーぬ接続時間",
			InputValue = "入力値",
			OpenInBrowser = "ブラウザーふぃらちゅん",
			SaveDataPath = "データパス保存",
			SetPageAsCover = "ページ表紙んかい設定",
			ResetCover = "表紙リセット",
			SupportDev = "開発者サポートする(Paypalっしサポートなやびーん!)",
			PressEdgesToChangePage = "ページぬ端うちページ変更",
			DownloadImageToMemory = "画像ダウンロード",
			AnimatedGif = "アニメーションGIF（実験的）",
			LoadSummary = "漫画ぬ概要表示すん",
		},
	SETTINGS_DESCRIPTION = {
			Library = "マンガ追跡ぬ設定",
			Catalogs = "言語、NSFWコンテンツ",
			Reader = "方向、んかい、ズームぬ設定",
			Network = "接続タイムアウト、プロキシ",
			Data = "保存、キャッシュぬ設定",
			AdvancedChaptersDeletion = "ゆでぃ、削除すん",
			DonatorsList = "プロジェクトサポートさるっちゅぬリスト",
			Other = "フォントぬ読み込み、チャプターぬ並べいけーい、通知",
			Controls = "キータイプ、ページボタンぬ変更、スティックぬ設定",
			About = "バージョン,、アップデート"
		},
		PAGINGCONTROLS = {
			["LR"] = "LうゆびRトリガー",
		...
		EXTRA = {
			["DownloadAll"] = "まじりぬチャプターダウンロード",
			["RemoveAll"] = "まじりぬチャプター削除",
			["CancelAll"] = "ダウンロード中ぬチャプターキャンセル",
			["ClearBookmarks"] = "ブックマーク削除",
			["OpenMangaInBrowser"] = "ブラウザーっし漫画ふぃらちゅん"
		},
		THEME = {
			Dark = "ダークテーマ",
			Light = "ライトテーマ",
		...
		WARNINGS = {
			NO_CHAPTERS = "チャプターやあいびらん"
		},
		READER = {
			PREPARING_PAGES = "ページぬしこーい",
			LOADING_PAGE = "ページロード中...",
			LOADING_SEGMENT = "セグメントぬ読み込み",
			Horizontal = "水平",
			Vertical = "垂直",
			Smart = "スマート",
			Height = "高さ",
		...
		NOTIFICATIONS = {
			ADDED_TO_LIBRARY = "ライブラリーんかい追加",
			REMOVED_FROM_LIBRARY = "ライブラリーから削除",
			SEARCHING = '"％s検索"',
			START_DOWNLOAD = "%s：%s\nダウンロードぬ開始さりやびたん！",
			END_DOWNLOAD = "%s: %s\nダウンロードんかいでぃかさびたん！",
			CANCEL_DOWNLOAD = "%s: %s\nダウンロードーキャンセルさりやびたん！",
			CHAPTER_REMOVE = "%s 削除さりやびたん！",
			NET_PROBLEM = "接続んかい問題があいびーん！",
			CHAPTERS_CLEARED = "たぶらったるチャプターやまじりクリアさりやびーん！",
			LIBRARY_CLEARED = "ライブラリーぬクリアさりやびたん！",
			CACHE_CLEARED = "キャッシュぬクリアさりやびたん！",
			DEVELOPER_THING = "Githubぬスターアプリ！",
			NEW_UPDATE_AVAILABLE = "みーさるアップデートぬ利用可能やいびーん！",
			NO_SPACE_LEFT = "スペースぬぬくやびらん",
			REFRESH_COMPLETED = "更新ぬしーうわやびたん！",
			IMPORT_COMPLETED = "インポートぬしーうわやびたん！",
			SETTINGS_RESET = "設定ぬリセットさりやびたん",
			BAD_IMAGE_FOUND = "わっさる画像ぬ見ちかやびたん！",
			COVER_SET_COMPLETED = "表紙更新さびたん！"
		},
		MODES = {
			Popular = "人気順",
			Latest = "最新",
		...
		PANEL = {
			...
			--MODE_POPULAR = "モード：人気",
			--MODE_LATEST = "モード：最新",
			--MODE_SEARCHING = "モード：「％s」検索"',
			JUMPTOPAGE = "ページ変更",
			SEARCH = "検索",
			SELECT = "選択",
			CHOOSE = "いらぶん",
			IMPORT = "インポート",
			CHANGE_SECTION = "セクション変更",
			UPDATE = "更新",
			CANCEL = "キャンセル",
			DELETE = "削除",
			FOLLOW = "フォロー",
