...
Language = {
	...
	French = {
		...
		SETTINGS = {
			Language = "Language",
			AdvancedChaptersDeletion = "Suppression avancé des chapitres sauvegardé",
			DonatorsList = "Liste des donateurs", 
			ClearChapters = "Supprimer les chapitres sauvegardé",
			ShowNSFW = "Afficher les contenus NSFW",
		...
		SETTINGS_DESCRIPTION = {
			...
			DonatorsList = "Liste des personnes qui ont participé au projet", 
			Other = "Chargement de la police, organisation des chapitres, notifications",
			Controls = "Bouton d'action, de changement de page et paramètre des joystick",
		...
		EXTRA = {
			...
			["ClearBookmarks"] = "Vider les marques de pages",
		...
		NOTIFICATIONS = {
			...
			SEARCHING = 'Rechercher en cours : "%s"',
			...
			DEVELOPER_THING = "Donner une étoile à l'app sur son github!",
