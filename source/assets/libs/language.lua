...
Language = {
	...
	French = {
		...
		MESSAGE = {
			...
			THANK_YOU = "Merci de votre support envers le projet", --Translate please
		},
		SETTINGS = {
			Language = "Language",
			AdvancedChaptersDeletion = "Suppression des chapitres sauvegardé avancé",
			DonatorsList = "Liste des donateurs", --Translate please
			...
			DownloadImageToMemory = "Télécharger l'image", --Translate please
			AnimatedGif = "Animer les gif (Experimental)", --Translate please
			LoadSummary = "Afficher un résumé du manga", --Translate please
		},
		SETTINGS_DESCRIPTION = {
			...
			DonatorsList = "Liste des personnes qui ont supporté le projet", --Translate please
