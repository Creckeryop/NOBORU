...
Language = {
	...
	Turkish = {
		...
		DETAILS = {
			...
			START = "Okumaya Başla",
			DONE = "Tamamlandı!",
			SUMMARY = "Konusu", --Translate please
			SHRINK = "Daha Az", --Translate please
			EXPAND = "Daha Fazla" --Translate please
		},
		NOTIFICATIONS = {
	...
	French = {
		...
		MESSAGE = {
			...
			NO_LIBRARY_MANGA = "Pas de manga/comics.\nPour ajouter des mangas/comics, vous pouvez aller dans le menu\"CATALOGUE\" et appuyer \"Ajouter à la librairie\".", --translate please
			NO_HISTORY_MANGA = "Pas de manga/comics.\nCela viendra un jour", --translate please
			NO_CATALOG_MANGA = "Pas de manga/comics.\nErreur de connexion, server ou d'analyseur", --translate please
			NO_DOWNLOADING_MANGA = "Pas de téléchargement de manga/comics", --translate please
			NO_CATALOGS = "Pas de catalogue.\nAppuyez sur Triangle et attendez jusqu'à ce que les catalogues soient chargé.", --translate please
		},
		SETTINGS = {
			Language = "Language",
			AdvancedChaptersDeletion = "Suppression des chapitres sauvegardé avancé", --Translate please
			ClearChapters = "Supprimer les chapitres sauvegardé",--Retranslate "Clear all saved chapters" please
			...
			SetPageAsCover = "Choisir cette page comme couverture", --translate please
			ResetCover = "Restaurer la couverture", --translate please
			SupportDev = "Supporter le développeur", --translate please
			PressEdgesToChangePage = "Changer de page en appuyant sur le bord des pages", --translate plaese
		},
		SETTINGS_DESCRIPTION = {
			Library = "Paramètres de suivi des mangas", --translate please
			Catalogs = "Langage, contenu NSFW", --translate please
			Reader = "Sens de lecture, orientation, zoom", --translate please
			Network = "Durée du délai de connexion, proxy", --translate please
			Data = "Sauvegarde, cache, paramètres", --translate please
			AdvancedChaptersDeletion = "Lire, Supprimer", --translate please
			Other = "Chargement de la police, organisation des chapitres, notifications", --translate please
			Controls = "Action o et x, bouton de changement de page, sticks settings", --translate please
			About = "Version, mise à jour" --translate please
		},
		PAGINGCONTROLS = {
			["LR"] = "Boutons L et R",
		...
		DETAILS = {
			...
			DONE = "Terminé !",
			SUMMARY = "Résumé", --Translate please
			SHRINK = "Réduire", --Translate please
			EXPAND = "Lire plus" --Translate please
		},
		NOTIFICATIONS = {
			...
			COVER_SET_COMPLETED = "La couverture a été mise à jour!" -- translate please
		},
		MODES = {
			Popular = "Populaire",
			Latest = "Nouveau",
	...
	PortugueseBR = {
		...
		DETAILS = {
			...
			DONE = "Completado!",
			SUMMARY = "Summary", --Translate please
			SHRINK = "Shrink", --Translate please
			EXPAND = "Read more" --Translate please
		},
		NOTIFICATIONS = {
			...
			COVER_SET_COMPLETED = "Cover was updated!" -- translate please
		},
		MODES = {
			Popular = "Popular",
			Latest = "Últimos",
