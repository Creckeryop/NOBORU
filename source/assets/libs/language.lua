...
Language = {
	...
	PortugueseBR = {
		...
		SETTINGS = {
			Language = "Idioma",
			AdvancedChaptersDeletion = "Exclusão de capítulos avançados",
		...
		SETTINGS_DESCRIPTION = {
			...
			Reader = "Orientação padrão do leitor, direção de leitura do manga, Escala do leitor",
			Network = "Tempo de conexão do servidor, proxy",
			Data = "Salvar caminho dos dados, limpar cache, resetar as configurações", 
			AdvancedChaptersDeletion = "leitura, remover",
			Other = "Carregamento de fontes, botões para mudar página, notificação de download",
			Controls = "Tipo de tecla, botões para mudar página, configurações do analógico",
			About = "versão, atualizar"
		},
		PAGINGCONTROLS = {
			["LR"] = "Botões L e R",
			["DPAD"] = "Usando DPad"
		...
		NOTIFICATIONS = {
			...
			COVER_SET_COMPLETED = "A capa foi atualizada!"
		},
		MODES = {
			Popular = "Popular",
			Latest = "Últimos",
